 ...
 */
unsigned int hash_str(unsigned char* str, const size_t len, unsigned char* hash_result)
{
    unsigned int ret;
...
unsigned int hashhash_str(unsigned char* str, const size_t len, unsigned char* hash_result)
{
